#!/usr/bin/env python
"""
Replace specific text at the start of lines across multiple files (non-recursive).
...
def print_header():
    ...
    print("Replace specific text at the start of lines across multiple files (non-recursive).")
